...
<form method="POST" action="{{ route('inscripcion.update', $inscripcion->id_inscripcion_pk) }}" enctype="multipart/form-data" novalidate>
    @csrf
     @method('PUT')
        <div class="form-row justify-content-center">
            ...
            id="id_inscripcion" value="{{$inscripcion->id_inscripcion_pk}}" placeholder="ingrese id "/>
          ...
          <div class="form-group col-md-4">
            ...
            id="num_control" value="{{$inscripcion->num_control}}" placeholder="ingrese numero control"/>
        ...
        <div class="form-row justify-content-center">
            <div class="form-group col-md-4">
              ...
              id="fecha_inscripcion" value="{{$inscripcion->fecha_inscripcion}}" placeholder="ingrese fecha de inscripcion"/>
             ...
             >
                ...
                @foreach ($periodos as $periodo)
                    <option
                        ...
                        {{ $inscripcion->id_periodo_fk == $periodo->id_periodo_pk ? 'selected' : '' }}
                 ...
                 >
                    ...
                    @foreach ($actividades as $actividad)
                        <option
                            ...
                            {{$inscripcion->id_actividad_fk== $actividad->id_actividad_pk ? 'selected' : '' }}
