...
<div class="card shadow-lg border-0">
        <div class="card-header">
          ...
          <a href="{{route('periodo.create')}}" class="mr-5 text-light btn float-right btn-spinner btn-sm " style="background-color: #77212E;"> <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-person-plus-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <thead class="text-light" style="background-color: #003366;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $periodo->id_periodo_pk }}</td>
                                    <td>{{ $periodo->nombre_periodo }}</td>
                                    <td>{{ $periodo->fecha_inicio }}</td>
                                    <td>{{ $periodo->fecha_final }}</td>
                                    <td>{{ $periodo->estatus }}</td>
                                    <td><a href="{{ route('periodo.edit', $periodo->id_periodo_pk) }}"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi text-success bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
