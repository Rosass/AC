...
<div class="card shadow-lg border-0">
        <div class="card-header">
          ...
          <a href="{{route('actividad.create')}}" class="mr-5 text-light btn float-right btn-spinner btn-sm " style="background-color: #77212E;"> <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-person-plus-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <table class="table text-center table-hover table-listing">
                        <thead class="text-light" style="background-color: #003366;">
                            <tr>
                                ...
                                <th scole="col">Numero Dictamen</th>
                                <th scole="col">Creditos</th>
                                <th scole="col">Cap. Alumnos</th>
                                <th scole="col">Area</th>
                                <th scole="col">periodo</th>
                                <th scole="col">Responsable</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $actividad->capacidad_alumnos }}</td>
                                    <td>{{ $actividad->id_area_fk }}</td>
                                    <td>{{ $actividad->id_periodo_fk }}</td>
                                    <td>{{ $actividad->rfc_responsable_fk }}</td>
                                    <td>{{ $actividad->estatus }}</td>
                                    <td><a href="{{ route('actividad.edit', $actividad->id_actividad_pk) }}"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi text-success bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
