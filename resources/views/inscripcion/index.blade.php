...
<div class="card shadow-lg border-0">
        <div class="card-header">
          ...
          <a href="{{route('inscripcion.create')}}" class="mr-5 text-light btn float-right btn-spinner btn-sm " style="background-color: #77212E;"> <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-person-plus-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="table-responsive">
                    <table class="table text-center table-hover table-listing">
                        <thead class="text-light" style="background-color: #003366;">
                            <tr>
                                <th scole="col">Id</th>
                                <th scole="col">Numero de control</th>
                                <th scole="col">fecha inscripcion</th>
                                <th scole="col">id periodo</th>
                                <th scole="col">id actividad</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $inscripcion->id_inscripcion_pk }}</td>
                                    <td>{{ $inscripcion->num_control }}</td>
                                    <td>{{ $inscripcion->fecha_inscripcion }}</td>
                                    <td>{{ $inscripcion->id_periodo_fk }}</td>
                                    <td>{{ $inscripcion->id_actividad_fk }}</td>
                                    <td>{{ $inscripcion->estatus }}</td>
                                    <td><a href="{{ route('inscripcion.edit', $inscripcion->id_inscripcion_pk) }}"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi text-success bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
